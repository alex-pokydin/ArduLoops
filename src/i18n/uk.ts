...
export const uk: Record<string, string> = {
  ...
  Lines: "лінії",
  "{n} lines": "{n} лінії",
  "pick any live line": "будь-яка жива лінія",
  "Live lines on this sample": "Живі лінії на цьому семплі",
  "Any live field. Mixed units share one scale.": "Будь-яке живе поле. Різні одиниці — одна шкала.",
  "Any live field or parameter. Mixed units share one scale.":
    "Будь-яке живе поле або параметр. Різні одиниці — одна шкала.",
  Search: "пошук",
  Live: "живе",
